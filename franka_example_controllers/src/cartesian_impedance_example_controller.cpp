...
bool CartesianImpedanceExampleController::init(hardware_interface::RobotHW* robot_hw,
  ...
  sub_desired_pose_ = node_handle.subscribe(
      "desired_ee_pose", 20, &CartesianImpedanceExampleController::desiredPoseCallback, this,
...
void CartesianImpedanceExampleController::desiredPoseCallback(
    const std_msgs::Float64MultiArrayConstPtr& msg) {
  position_d_target_ << msg->data[0], msg->data[1], msg->data[2];
  Eigen::Quaterniond last_orientation_d_target(orientation_d_target_);
  double roll, pitch, yaw;
  roll = msg->data[3];
  pitch = msg->data[4];
  yaw = msg->data[5];
  Eigen::Quaterniond quat_orientation_d_target;
  quat_orientation_d_target = Eigen::AngleAxisd(roll, Eigen::Vector3d::UnitX())
    * Eigen::AngleAxisd(pitch, Eigen::Vector3d::UnitY())
    * Eigen::AngleAxisd(yaw, Eigen::Vector3d::UnitZ());
  orientation_d_target_.coeffs() = quat_orientation_d_target.coeffs();
